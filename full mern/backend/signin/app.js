...
app.post('/signin', async (req, res) => {
  try {
    ...
    if (!username || !password) {
      return res.render('signin', { error: 'Username and password are required' });
    }
...
// Serve static files from the 'vite-project/dist' folder (for JS, CSS, etc.)
...
app.get('/app', (req, res) => {
  ...
  // Serve the index.html file from 'vite-project/dist' (React App entry point)
